...
export const VERSIONS_DATA: VersionInfo[] = [
  {
    ...
    fileSize: '84.6 MB',
    sha256: '9f8a37d6e28944288a2505d9c1dadc9e37894a8fbc64920401848523091abff8',
    downloadUrl: '#download-v1.0.0',
    portableUrl: '#download-portable-v1.0.0',
    msiUrl: '#download-msi-v1.0.0',
