...
export const VERSIONS_DATA: VersionInfo[] = [
  {
    ...
    fileSize: '84.6 MB',
    sha256: '',
    downloadUrl: 'https://github.com/valentinlihosanchez/TanTan/releases/download/v1.0.0/TanTan%20SistemPOS%20Setup%201.0.0.exe',
    portableUrl: 'https://github.com/valentinlihosanchez/TanTan/releases/download/v1.0.0/TanTan%20SistemPOS%201.0.0.exe',
    msiUrl: '',
